...
│
├── plot_graphs.py                                      # Script to generate graphs
├── README.md                                           # Project documentation
├── .gitignore
│
├── Topsis-Dataset.csv                                  # Sample input dataset
|
├── text_classification_result.csv                      #Example
├── modelResults.csv
├── topsis_scores.png # TOPSIS score graph
└── topsis_ranking.png # Ranking graph
